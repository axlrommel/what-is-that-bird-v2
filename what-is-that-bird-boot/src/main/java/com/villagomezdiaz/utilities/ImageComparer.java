...
import com.villagomezdiaz.common.results.FilterType;
import com.villagomezdiaz.common.results.FilterTypeEnum;
...
//		 cloneOutput.setExecutable(true, true);
		 ...
		 results = getMatchingResults(imageIn, jedis);
		}
		catch(Exception e) {
			e.printStackTrace();
		}
	...
	private ArrayList<JedisCorrelationResults> initFilters(String appendString) {
		ArrayList<JedisCorrelationResults> correlationResults = new ArrayList<JedisCorrelationResults>();
		 ...
		 correlationResults.add(new JedisCorrelationResults(new FilterType(FilterTypeEnum.RGB),
				 appendString + "threecolor-corr"));

		 correlationResults.add(new JedisCorrelationResults(new FilterType(FilterTypeEnum.LOW),
				 appendString + "low-corr"));
		 
		 correlationResults.add(new JedisCorrelationResults(new FilterType(FilterTypeEnum.HIGH),
				 appendString + "high-corr"));

		 correlationResults.add(new JedisCorrelationResults(new FilterType(FilterTypeEnum.RED),
				 appendString + "red-corr"));

		 correlationResults.add(new JedisCorrelationResults(new FilterType(FilterTypeEnum.GREEN),
				 appendString + "green-corr"));

		 correlationResults.add(new JedisCorrelationResults(new FilterType(FilterTypeEnum.BLUE),
				 appendString + "blue-corr"));

		 correlationResults.add(new JedisCorrelationResults(new FilterType(FilterTypeEnum.YELLOW),
				 appendString + "yellow-corr"));

		 correlationResults.add(new JedisCorrelationResults(new FilterType(FilterTypeEnum.CYAN),
				 appendString + "cyan-corr"));

		 correlationResults.add(new JedisCorrelationResults(new FilterType(FilterTypeEnum.MAGENTA),
				 appendString + "magenta-corr"));
